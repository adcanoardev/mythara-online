...
const DISTRICTS: District[] = [
    { id: "nexus",   name: "Nexus",   color: "#a78bfa", description: "Arcane summoning portal",        route: "/nexus",   px: 0.50, py: 0.36, hitW: "12%", hitH: "23%" },
    { id: "arena",   name: "Arena",   color: "#ef4444", description: "Combat · Sanctums · PvP",        route: "/arena",   px: 0.68, py: 0.22, hitW: "18%", hitH: "18%" },
    { id: "tavern",  name: "Tavern",  color: "#f59e0b", description: "Binders · Ranking · Social",     route: "/tavern",  px: 0.27, py: 0.43, hitW: "19%", hitH: "18%" },
    { id: "inn",     name: "Inn",     color: "#84cc16", description: "Mine · Forge · Lab · Nursery",   route: "/inn",     px: 0.24, py: 0.62, hitW: "19%", hitH: "15%" },
    { id: "market",  name: "Market",  color: "#38bdf8", description: "Shop · Gold · Diamonds",         route: "/market",  px: 0.75, py: 0.44, hitW: "19%", hitH: "18%" },
    { id: "arcanum", name: "Arcanum", color: "#60a5fa", description: "Mythsdex · Encyclopedia",        route: "/arcanum", px: 0.50, py: 0.14, hitW: "9%",  hitH: "20%" },
    { id: "guild",   name: "Guild",   color: "#fbbf24", description: "Missions · Achievements · Pass", route: "/guild",   px: 0.50, py: 0.63, hitW: "15%", hitH: "17%" },
];
...
const CITY_URL =
    "https://cdn.jsdelivr.net/gh/adcanoardev/mythara-assets@81c51f89d09f16cc90e5f27120248764d8736557/maps/main_city_base.webp";
    ...
    return (
        <div className="w-screen h-screen overflow-hidden relative bg-black flex flex-col select-none">
            <style>{`
                ...
                .bar-btn:active .bar-icon-wrap { transform:scale(0.88); background:rgba(255,255,255,0.18); border-color:rgba(255,255,255,0.35); }
                .bar-icon-wrap-battle {
                    width:54px !important; height:54px !important;
                    background:linear-gradient(160deg,rgba(239,68,68,0.70) 0%,rgba(153,27,27,0.85) 100%) !important;
                    border:2.5px solid rgba(239,68,68,0.75) !important;
                    box-shadow:0 0 18px rgba(239,68,68,0.45),0 3px 12px rgba(0,0,0,0.6),inset 0 1px 0 rgba(255,160,160,0.20),inset 0 -1px 0 rgba(0,0,0,0.4) !important;
                }
            `}</style>
            ...
            <div
                ...
                style={{
                    zIndex: 20,
                    // Lighter gradient — image visible through it
            ...
            >
                {/* Avatar */}
                <div className="flex items-center gap-4 pointer-events-all flex-shrink-0">
                    <div style={{ position: "relative", width: "86px", height: "86px", flexShrink: 0 }}>
                        ...
                        <img src={AVATAR_URL(avatar)} onError={e => { (e.target as HTMLImageElement).style.opacity = "0"; }}
                    ...
                    <div style={{ minWidth: 0 }}>
                        ...
                        <div style={{ fontSize: "13px", color: "rgba(251,191,36,0.60)", marginTop: "3px", fontFamily: "Rajdhani, sans-serif" }}>
                            Binder · Lv {binderLevel}
                        </div>
                        <div style={{ width: "130px", height: "8px", background: "rgba(255,255,255,0.12)", borderRadius: "4px", marginTop: "8px", overflow: "hidden" }}>
                            <div style={{
                                width: `${xpPct}%`, height: "100%", borderRadius: "4px",
                                background: "linear-gradient(90deg, #facc15 0%, #fde68a 45%, #facc15 60%, #facc15 100%)",
                                backgroundSize: "200% auto", animation: "xpShimmer 3s linear infinite", transition: "width 0.5s",
                            }} />
                        </div>
                        <div style={{ fontSize: "12px", color: "rgba(251,191,36,0.50)", marginTop: "3px", fontFamily: "Rajdhani, sans-serif" }}>
                            {Math.round(xpPct)}% XP
                        </div>
                    </div>
                </div>
            ...
            <div ref={containerRef} className="flex-1 relative overflow-hidden city-grab"
                ...
                <div ref={mapRef} className="absolute top-0 left-0" style={{
                    ...
                    {/* ── NEXUS BEAM — short thick light pillar, no CSS circles ── */}
                    <div className="absolute pointer-events-none" style={{ left:`${nexus.px*100}%`, top:`${nexus.py*100}%`, zIndex:4 }}>
                        {/* Wide diffuse beam */}
                        <div style={{
                            position:"absolute", top:"30%", left:"50%",
                            width:"clamp(55px,7vw,95px)", height:"clamp(75px,9vw,135px)",
                            transform:"translate(-50%, -100%)",
                            background:"linear-gradient(to top,rgba(205,228,255,0.55) 0%,rgba(232,246,255,0.82) 40%,rgba(248,254,255,0.52) 72%,transparent 100%)",
                            filter:"blur(13px)",
                            animation:"nexusBeam 4s ease-in-out infinite",
                            mixBlendMode:"screen",
                        }} />
                        {/* Thin bright core */}
                        <div style={{
                            position:"absolute", top:"30%", left:"50%",
                            width:"clamp(11px,1.4vw,20px)", height:"clamp(58px,7.5vw,110px)",
                            transform:"translate(-50%, -100%)",
                            background:"linear-gradient(to top,rgba(232,246,255,0.95) 0%,rgba(255,255,255,1) 40%,rgba(242,250,255,0.65) 72%,transparent 100%)",
                            filter:"blur(3px)",
                            animation:"nexusBeamCore 3s ease-in-out infinite",
                            mixBlendMode:"screen",
                        }} />
                        {/* Base pool of light */}
                        <div style={{
                            position:"absolute", top:"44%", left:"50%",
                            width:"clamp(80px,10vw,145px)", height:"clamp(26px,3vw,44px)",
                            transform:"translate(-50%, -50%)",
                            borderRadius:"50%",
                            background:"radial-gradient(ellipse,rgba(215,235,255,0.90) 0%,rgba(175,208,255,0.45) 42%,transparent 72%)",
                            filter:"blur(9px)",
                            animation:"nexusBaseGlow 3s ease-in-out infinite 0.4s",
                        }} />
                    </div>
                        ...
                        return (
                            ...
                            >
                                ...
                                <div style={{
                                    ...
                                    background:`radial-gradient(ellipse,${d.color}38 0%,${d.color}12 55%,transparent 78%)`,
                                    opacity: hovered ? 1 : 0,
                                    transition:"opacity 0.3s ease",
                                    animation: hovered ? "districtGlowPulse 1.8s ease-in-out infinite" : "none",
                                    pointerEvents:"none",
                                }} />
                                ...
                                <div style={{
                                    position:"relative",
                                    background: hovered ? "rgba(4,7,16,0.88)" : "rgba(4,7,16,0.68)",
                                    border: `1.5px solid ${hovered ? d.color + "cc" : d.color + "55"}`,
                                    borderRadius: "8px",
                                    padding: "5px 16px 5px",
                                    marginBottom: "5px",
                                    backdropFilter: "blur(6px)",
                                    boxShadow: hovered ? `0 0 20px ${d.color}55, 0 2px 14px rgba(0,0,0,0.9)` : "0 2px 10px rgba(0,0,0,0.7)",
                                    transition: "all 0.2s ease",
                                    pointerEvents:"none",
                                }}>
                                    <div style={{
                                        color: "#ffffff",
                                        // Mobile-first: 22px base, 28px on hover
                                        fontSize: hovered ? "28px" : "22px",
                                        ...
                                        whiteSpace: "nowrap",
                                        textShadow: hovered
                                            ? `0 0 22px ${d.color}, 0 0 10px ${d.color}99, 0 2px 8px rgba(0,0,0,1)`
                                            : "0 1px 4px rgba(0,0,0,1), 0 2px 12px rgba(0,0,0,1)",
                                        transition: "font-size 0.18s ease, text-shadow 0.2s ease",
                                    }}>{d.name}</div>
                                </div>

                                {/* Description on hover — big and readable */}
                                {hovered && (
                                    <div style={{
                                        position:"relative",
                                        color: "#ffffff",
                                        ...
                                        whiteSpace: "nowrap",
                                        marginBottom: "4px",
                                        textShadow: `0 0 14px ${d.color}, 0 1px 6px rgba(0,0,0,1)`,
                                        pointerEvents:"none",
            ...
            <div style={{
                ...
                background:"linear-gradient(to bottom,rgba(4,7,16,0) 0%,rgba(6,10,22,0.98) 18px,rgba(6,10,22,1) 100%)",
                borderTop:"1px solid rgba(255,255,255,0.08)",
                paddingBottom:"max(8px,env(safe-area-inset-bottom))",
                paddingTop:"2px", display:"flex",
                ...
                {BOTTOM_BAR.map((btn, idx) => {
                    ...
                    return (
                        <button key={btn.route} className="bar-btn" onClick={() => navigate(btn.route)} style={{
                            ...
                            minHeight:"74px", padding:"8px 4px",
                            background:"transparent", border:"none",
                            borderRight:idx<BOTTOM_BAR.length-1?"1px solid rgba(255,255,255,0.05)":"none",
                            cursor:"pointer", position:"relative",
                        }}>
                            <div style={{
                                position:"absolute",top:0,left:"25%",right:"25%",height:"2px",
                                background:isBattle
                                    ?"linear-gradient(90deg,transparent,rgba(239,68,68,0.80),transparent)"
                            ...
                            <span style={{
                                ...
                                color:isBattle?"#fca5a5":"rgba(232,240,254,0.58)", lineHeight:1,
                            }}>{btn.label}</span>
                        </button>
                    );
                })}
            ...
            {chatOpen && (
                <>
                    <div onClick={() => setChatOpen(false)} style={{
                        ...
                        background:"rgba(4,7,16,0.55)",backdropFilter:"blur(3px)",
                    }} />
                    <div style={{
                        ...
                        ...(isMobile ? {
                            ...
                            animation:"chatSlideUp 0.26s cubic-bezier(0.34,1.2,0.64,1) forwards",
                            boxShadow:"0 -8px 40px rgba(0,0,0,0.7)",
                        } : {
                            top:0,right:0,bottom:0,width:"340px",
                            borderLeft:"1px solid rgba(99,102,241,0.30)",
                            animation:"chatSlideIn 0.22s cubic-bezier(0.34,1.2,0.64,1) forwards",
                            boxShadow:"-8px 0 40px rgba(0,0,0,0.6)",
                        }),
                    }}>
                        {isMobile && (
                            <div style={{ display:"flex",justifyContent:"center",padding:"10px 0 4px" }}>
                                <div style={{ width:"40px",height:"4px",borderRadius:"2px",background:"rgba(255,255,255,0.20)" }} />
                            </div>
                        )}
                        <div style={{
                            display:"flex",alignItems:"center",justifyContent:"space-between",
                            padding:"14px 16px 12px",
                            paddingTop:isMobile?"10px":"max(16px,env(safe-area-inset-top))",
                            ...
                            <div style={{ display:"flex",gap:"8px" }}>
                                {["Global","Guild"].map((tab,i) => (
                                    <button key={tab} style={{
                                        ...
                                        border:i===0?"1px solid rgba(99,102,241,0.50)":"1px solid rgba(255,255,255,0.10)",
                                        color:i===0?"#a5b4fc":"rgba(232,240,254,0.45)",
                            ...
                            <button onClick={() => setChatOpen(false)} style={{
                                ...
                                color:"rgba(232,240,254,0.55)",fontSize:"16px",
                        ...
                        <div style={{
                            ...
                            <input type="text" placeholder="Enter your message..." style={{
                                flex:1,padding:"10px 14px",
                                background:"rgba(255,255,255,0.06)",
                                border:"1px solid rgba(255,255,255,0.12)",
                                borderRadius:"10px",color:"#e8f0fe",fontSize:"14px",
